...
public class Main{
    public static void main(String[] args) {
        ...
        peopleMap.put(new Contact("Bob", 35), "4046 Weekly Street");
        ...
        peopleMap.put(new Contact("Adam", 42), "146 Devils Hills Road");
        peopleMap.put(new Contact("Hilary", 34), "397 Winifred Way");
        peopleMap.put(new Contact("Noah", 41), "1883 Maloy Court");

        System.out.println("\n Alice's address is: " + peopleMap.get(new Contact("Alice", 30)));
        System.out.println("\n Adam's address is: " + peopleMap.get(new Contact("Adam", 42)));
        System.out.print("\n Noah, 41 years of age, in my contacts? ");
        String response = peopleMap.containsKey(new Contact("Noah", 41)) ? "Yes!" : "No!";
